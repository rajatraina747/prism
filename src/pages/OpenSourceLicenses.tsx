...
const LICENSES = [
  ...
  { name: 'mpv / libmpv', version: '0.41', license: 'GPL-2.0-or-later (macOS build) / LGPL-2.1 (Windows build)', url: 'https://github.com/mpv-player/mpv' },
  { name: 'libmpv-wrapper', version: 'latest', license: 'LGPL-2.1', url: 'https://github.com/nini22P/libmpv-wrapper' },
  { name: 'tauri-plugin-libmpv', version: '0.3.2 (vendored)', license: 'MPL-2.0', url: 'https://github.com/nini22P/tauri-plugin-libmpv' },
